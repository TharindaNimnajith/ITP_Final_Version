                    ...
                    <div id="addEmployeeModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" action="/saveTask1">
                                    {{csrf_field()}}
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{url('saveTask1')}}">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="std" class="form-control"
                                                       value="{{old('std')}}">
                                            </div>

                                            <div class="form-group">
                                                <label>Item Stocked Quantity</label>
                                                <input type="text" name="stq" class="form-control"
                                                       value="{{old('stq')}}">
                                            </div>

                                            <div class="form-group">
                                                <label>Item Issued Date</label>
                                                <input type="date" name="isd" class="form-control"
                                                       value="{{old('isd')}}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="isq" class="form-control"
                                                       value="{{old('isq')}}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="avq" class="form-control"
                                                       value="{{old('avq')}}">
                                            </div>
